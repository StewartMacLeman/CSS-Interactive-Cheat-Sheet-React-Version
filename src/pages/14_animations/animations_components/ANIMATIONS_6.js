...
const ANIMATIONS_6 = ({ toggleClasses, buttonUpdate }) => {
  // -------------------------------------
  const addedClass = styles.animationChange_6;
  ...
  return (
    <div className="cssTopicCont">
      <h3>Animations: animation-delay &amp; animation-fill-mode</h3>
