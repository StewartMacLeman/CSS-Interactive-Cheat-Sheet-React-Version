...
const ANIMATIONS_7 = ({ toggleClasses, buttonUpdate }) => {
  // -------------------------------------
  const addedClass = styles.animationChange_7;
  ...
  return (
    <div className="cssTopicCont">
      <h3>Animations: animation-iteration-count V1</h3>
