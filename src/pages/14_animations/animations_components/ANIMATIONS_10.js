...
const ANIMATIONS_10 = ({ toggleClasses, buttonUpdate }) => {
  // -------------------------------------
  const addedClass = styles.animationChange_10;
  ...
  return (
    <div className="cssTopicCont">
      <h3>Animations: animation-timing-function</h3>
