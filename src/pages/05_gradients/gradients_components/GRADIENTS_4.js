...
const GRADIENTS_4 = ({ toggleClasses, buttonUpdate }) => {
  // -------------------------------------
  const addedClass = styles.gradientsChange_4;
  ...
  const cssCode = `div {
    background-image: 
    linear-gradient(to left, darkgreen, palegreen);
    }`;
  // -------------------------------------
