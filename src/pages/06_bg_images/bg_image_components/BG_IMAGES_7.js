...
const BG_IMAGES_7 = ({ toggleClasses, buttonUpdate }) => {
  // -------------------------------------
  const addedClass = styles.backgroundChange_7;
  ...
  return (
    <div className="cssTopicCont">
      <h3>Background Images: background-repeat V3</h3>
