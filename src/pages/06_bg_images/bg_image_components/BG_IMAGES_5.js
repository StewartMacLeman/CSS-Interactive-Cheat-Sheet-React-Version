...
const BG_IMAGES_5 = ({ toggleClasses, buttonUpdate }) => {
  // -------------------------------------
  const addedClass = styles.backgroundChange_5;
  ...
  return (
    <div className="cssTopicCont">
      <h3>Background Images: background-repeat V1</h3>
